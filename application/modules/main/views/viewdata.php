	...
	<section id="page-title" class="page-title-center">
		...
		<div class="container clearfix">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?= base_url('listdata.html')?>">คลังข้อมูลของเรา</a></li>
				<li class="breadcrumb-item"><a href="<?= base_url('listdatabycat.html/').$kb_categorycode?>">หมวดหมู่ <?=$kb_category?></a></li>
				<li class="breadcrumb-item active" aria-current="page"><?=$kb_title?></li>
			</ol>
		</div>

	</section><!-- #page-title end -->
	<input hidden type="text" name="checkEcodeV" id="checkEcodeV" value="<?=$kb_ecodepost?>">
	...
	<section id="content">
		...
		<div class="container clearfix">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="row">
						<div class="col-lg-12 addBtn">
							...
							data_kb_no = "{kbcode}"
							data_kb_userpost = "{kb_userpost}"
							data_kb_ecodepost = "{kb_ecodepost}"
							data_kb_deptnamepost = "{kb_deptnamepost}"
							data_kb_emailpost = "{kb_emailpost}"
							data_kb_title = "{kb_title}"
							data_kb_category = "{kb_category}"
							data_kb_catname = "{kb_category}"
							data_kb_catcode = "{kb_categorycode}"
							data_kb_detail = "{kb_detail}"
							data_kb_cause = "{kb_cause}"
							data_kb_action = "{kb_action}"
							data_kb_conclusion = "{kb_conclusion}"

							><i class="icon-edit-sign"></i>แก้ไข</a>
							<!-- Load menu bar -->
				...
				<section id="commentzone" style="display:none;">
					<form id="frm_comment">
